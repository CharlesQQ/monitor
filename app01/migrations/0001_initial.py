# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-02-23 08:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_groups', models.ManyToManyField(blank=True, to='app01.HostGroup')),
                ('hosts', models.ManyToManyField(blank=True, to='app01.Host')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Service', verbose_name='\u5173\u8054\u670d\u52a1')),
                ('service_index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.ServiceIndex', verbose_name='\u5173\u8054\u670d\u52a1\u6307\u6807')),
        ...
        migrations.AddField(
            ...
            name='notifiers',
            field=models.ManyToManyField(blank=True, to='app01.UserProfile', verbose_name='\u901a\u77e5\u5bf9\u8c61'),
        ),
        migrations.AddField(
            model_name='action',
            name='host_groups',
        ...
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='\u60f3\u8ba9\u54ea\u4e9btrigger\u89e6\u53d1\u5f53\u524d\u62a5\u8b66\u52a8\u4f5c', to='app01.Trigger'),
        ),
    ]
